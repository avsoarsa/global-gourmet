    ...
    const placeholderProducts = [
      {
        ...
        price: 12.99,
        image_url: '/images/products/almonds.jpg',
        rating: 4.8,
        is_bestseller: true,
        is_organic: true,
        stock_quantity: 50
      },
      {
        ...
        price: 14.99,
        image_url: '/images/products/cashews.jpg',
        rating: 4.7,
        is_bestseller: false,
        is_organic: true,
        stock_quantity: 35
      },
      {
        ...
        price: 8.99,
        image_url: '/images/products/trail-mix.jpg',
        rating: 4.5,
        is_bestseller: false,
        is_organic: false,
        stock_quantity: 60
      },
      {
        ...
        slug: 'pistachios',
        price: 16.99,
        image_url: '/images/products/walnuts.jpg',
        rating: 4.9,
        is_bestseller: true,
        is_organic: false,
        stock_quantity: 25
